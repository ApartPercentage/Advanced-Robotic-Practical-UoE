...
target1 = np.array([0.41034839, 0.25796086, 0.18905828])
target1 += np.array([0.2, -0.1, 0.1])
pltTime, pltDistance = sim.move_without_PD(endEffector1, target1, speed=1.2, orientation=ori1, threshold=1e-3, maxIter=3000, debug=False, verbose=False)
